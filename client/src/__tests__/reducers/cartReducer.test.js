...
describe('cart reducer', () => {
  ...
  it('should handle GET_CATALOG', () => {
    ...
    expect(cartReducerResult).toEqual(expectedResult);
  });

  it('should handle GET_CART - without items in cart', () => {
    const testAction = {
      type: GET_CART,
      itemsInCart: []
    };
    ...
    const cartReducerResult = cartReducer(initState, testAction);
    expect(cartReducerResult).toEqual(initState);
  });

  it('should handle ADD_ITEM - without item in cart', () => {
    const testAction = {
      type: ADD_ITEM,
      id: 1
    };
    ...
    const cartReducerResult = cartReducer(initState, testAction);
    expect(cartReducerResult.total).toEqual(expectedTotal);
  });

  it('should handle ADD_ITEM - with item in cart', () => {
    const testAction = {
      type: ADD_ITEM,
      id: 1,
    };
  ...
  it('should handle SUB_QUANTITY - with item in cart', () => {
    const testAction = {
      type: SUB_QUANTITY,
      id: 1,
    };
  ...
  it('should handle GET_CART - with items in cart', () => {
    const testAction = {
      type: GET_CART,
